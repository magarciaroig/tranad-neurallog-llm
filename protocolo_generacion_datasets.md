> [!NOTE]
> **English documentation available:** For the English version of this protocol, please see [`protocolo_generacion_datasets.en.md`](protocolo_generacion_datasets.en.md).
